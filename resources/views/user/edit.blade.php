            ...
            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                <div
                    ...
                    <a href="{{ route('users.index') }}"
                        class="mt-1 text-sm font-normal px-3 py-1 rounded bg-blue-600 text-white">All User</a>
                </div>
                <form class="p-5 lg:max-w-4xl mx-auto dropzone" action="{{ route('users.update', $user->id) }}"
                    method="POST">
                        ...
                        <div class="w-1/2 mx-auto">
                            ...
                            <div class="mb-6">
                                <label for="userPassword"
                                    ...
                                    <small class="text-blue-700">(leave it empty, if you don't want to change)</small>
                                </label>
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center pl-3">
                                            ...
                                            <label for="horizontal-list-radio-license"
                                                class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Active
                                            </label>
                                        </div>
                                    </li>
                                    <li class="w-full dark:border-gray-600">
                                        <div class="flex items-center pl-3">
                                            <input id="horizontal-list-radio-passport" type="radio" value="0"
                                                name="status" @if (!$user->status) checked @endif
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="horizontal-list-radio-passport"
                                                class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Inactive</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
